...
export const FileInputTrigger = () => {
  ...
  return (
    <label
      htmlFor={id}
      className="group flex flex-1 cursor-pointer flex-col items-center gap-3 rounded-lg border border-x-zinc-300 px-6 py-4 text-center text-zinc-500 shadow-sm hover:border-violet-200 hover:bg-violet-25 hover:text-violet-500 dark:border-zinc-700 dark:hover:border-zinc-800 dark:hover:bg-zinc-800 dark:hover:text-violet-300"
    >
